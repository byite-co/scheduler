...
**AI 검사 원가와 상품 한도(2026-08-06 실측 기준):**
학생 프리미엄이 월 2,900원인데 AI 검사 1회 원가가 **실제 사진 1장 ≈ 4.3원**이다(§4-7).
무제한으로 열면 적자가 난다. 원가를 매출의 30% 이하로 두려면 **월 100회**가 상한선이다
(100회 × 평균 2장 ≈ 8.6원 = 860원 ≈ 매출의 30%). 하루 3회 남짓이라 실사용에는 충분하다.
서버 안전장치(하루 50회 · 같은 제출 5회)는 폭주 방어용이고 **상품 한도와 다른 층**이다.
