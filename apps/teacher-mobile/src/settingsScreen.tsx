  ...
  return (
    <ScrollView style={screenStyles.screen} contentContainerStyle={screenStyles.content}>
      ...
      <View style={styles.card}>
        ...
        <Pressable accessibilityRole="button" style={styles.row} onPress={() => router.push("/settings/profile")}>
          <Text style={styles.cardTitle}>프로필 편집</Text>
          <AppIcon color={colors.muted} name="chevronRight" />
        </Pressable>
      </View>

      <View style={styles.card}>
        <Text style={styles.cardTitle}>수업 운영</Text>
        <Pressable accessibilityRole="button" style={styles.row} onPress={() => router.push("/tools")}>
        ...
        <Pressable accessibilityRole="button" style={styles.row} onPress={() => router.push("/lesson-fees")}>
          <View style={{ flex: 1, gap: spacing.xs }}>
      ...
      <View style={styles.card}>
        ...
        <Pressable accessibilityRole="button" style={styles.row} onPress={() => router.push("/billing")}>
          <View style={{ flex: 1, gap: spacing.xs }}>
            <Text style={styles.cardTitle}>구독·정산</Text>
            <Text style={styles.meta}>과외쌤 앱 구독 상태와 현재 이용 기간을 확인해요.</Text>
          </View>
          <AppIcon color={colors.muted} name="chevronRight" />
        </Pressable>
        <Pressable accessibilityRole="button" style={styles.row} onPress={() => router.push("/legal/service")}>
          <Text style={styles.cardTitle}>서비스 이용약관</Text>
          <AppIcon color={colors.muted} name="chevronRight" />
        </Pressable>
        <Pressable accessibilityRole="button" style={styles.row} onPress={() => router.push("/legal/privacy")}>
          <Text style={styles.cardTitle}>개인정보 처리방침</Text>
          <AppIcon color={colors.muted} name="chevronRight" />
        </Pressable>
        <Pressable
          accessibilityRole="button"
          style={[styles.row, { borderColor: colors.danger }]}
        ...
        >
          ...
          <AppIcon color={colors.danger} name="chevronRight" />
        </Pressable>
      </View>
      ...
      <Pressable accessibilityRole="button" style={styles.secondaryButton} onPress={() => void signOut()}>
